...
export const TEST_ACCOUNTS = {
  superAdmin: {
    ...
    expectedNavItems: ['System Dashboard', 'All Schools', 'Seed Data'],
    blockedRoutes: [],
  },
  adminKings: {
  ...
  parentSingle: {
    ...
    expectedNavItems: ['Dashboard', 'My Children', 'Homework', 'Communication', 'Fees'],
    blockedRoutes: [
      '/system/schools',
      '/system/seed',
      '/school-settings',
...
export const API_BASE_URL =
  process.env.E2E_API_URL || 'https://api.skunect.com/api/v1';
